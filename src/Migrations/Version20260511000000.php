...
final class Version20260511000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($platform instanceof PostgreSQLPlatform) {
            $this->addSql('CREATE TABLE etl_planned_task (id UUID NOT NULL, workflow_id UUID DEFAULT NULL, enabled BOOLEAN NOT NULL, name VARCHAR(255) NOT NULL, schedule VARCHAR(255) NOT NULL, configuration JSON NOT NULL, input JSON NOT NULL, createdAt TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updatedAt TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
            $this->addSql('CREATE INDEX IDX_ETL_PLANNED_TASK_WORKFLOW ON etl_planned_task (workflow_id)');
            ...
            $this->addSql('ALTER TABLE etl_planned_task ADD CONSTRAINT FK_ETL_PLANNED_TASK_WORKFLOW FOREIGN KEY (workflow_id) REFERENCES etl_workflow (id) NOT DEFERRABLE INITIALLY IMMEDIATE');

            $this->addSql('ALTER TABLE etl_planned_task ADD pipeline_id UUID DEFAULT NULL');
            ...
            $this->addSql('ALTER INDEX idx_etl_planned_task_workflow RENAME TO IDX_39A2289C2C7C2CBA');

            return;
        }

        if ($platform instanceof MySQLPlatform || $platform instanceof MariaDBPlatform) {
            $this->addSql('CREATE TABLE etl_planned_task (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', workflow_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', enabled TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, schedule VARCHAR(255) NOT NULL, configuration JSON NOT NULL, input JSON NOT NULL, createdAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updatedAt DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
            $this->addSql('CREATE INDEX IDX_ETL_PLANNED_TASK_WORKFLOW ON etl_planned_task (workflow_id)');
            $this->addSql('ALTER TABLE etl_planned_task ADD CONSTRAINT FK_ETL_PLANNED_TASK_WORKFLOW FOREIGN KEY (workflow_id) REFERENCES etl_workflow (id)');

            $this->addSql('ALTER TABLE etl_planned_task ADD pipeline_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
            ...
            $this->addSql('CREATE INDEX IDX_39A2289CE80B93 ON etl_planned_task (pipeline_id)');
            $this->addSql('ALTER TABLE etl_planned_task RENAME INDEX idx_etl_planned_task_workflow TO IDX_39A2289C2C7C2CBA');
    ...
    public function down(Schema $schema): void
    {
        ...
        if ($platform instanceof PostgreSQLPlatform) {
            $this->addSql('ALTER TABLE etl_planned_task DROP CONSTRAINT FK_ETL_PLANNED_TASK_WORKFLOW');
        ...
        if ($platform instanceof MySQLPlatform || $platform instanceof MariaDBPlatform) {
            $this->addSql('ALTER TABLE etl_planned_task DROP FOREIGN KEY FK_ETL_PLANNED_TASK_WORKFLOW');
            $this->addSql('DROP TABLE etl_planned_task');
