...
final class Version20260511000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($platform instanceof PostgreSQLPlatform) {
            ...
            $this->addSql('COMMENT ON COLUMN etl_planned_task.created_at IS \'(DC2Type:datetime_immutable)\'');
            $this->addSql('COMMENT ON COLUMN etl_planned_task.updated_at IS \'(DC2Type:datetime_immutable)\'');
